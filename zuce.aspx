...
<body>
    <form id="form1" runat="server">
        <div id="container">
        <div id="left"><img  src="images/zuce.jpg" />j</div>
    <div id="content">
        <div id="head"> 
             <div id="top1"><img  src="images/logo.png" style="height: 34px; width: 193px"/></div>
             <div id="top2">注册新用户</div>
    ...
    <table id="zhuche" >
         <tr>
                ...
                <td  colspan="2" >
                    <asp:TextBox ID="usernameTextBox" runat="server" Width="143px" OnTextChanged="usernameTextBox_TextChanged1"></asp:TextBox>
                </td>
                <td >
